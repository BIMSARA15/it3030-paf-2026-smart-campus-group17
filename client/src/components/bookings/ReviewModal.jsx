    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md z-10">
        ...
        <div className="px-5 pb-5 flex gap-2">
          ...
          <button onClick={handleSubmit} disabled={isSubmitting} className={`flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl text-white text-sm font-medium transition-all ${isSubmitting ? 'opacity-70 cursor-not-allowed ' : ''}${action === 'approve' ? 'bg-emerald-600 hover:bg-emerald-700' : action === 'cancel' ? 'bg-amber-600 hover:bg-amber-700' : 'bg-red-600 hover:bg-red-700'}`}>
