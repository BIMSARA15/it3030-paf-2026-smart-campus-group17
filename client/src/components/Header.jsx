...
export default function Header() {
  ...
  // --- NOTIFICATION STATE ---
  // We keep the notifications array to count unread messages for the red dot
  ...
  return (
    <header className="bg-white border-b border-gray-100 h-16 flex items-center justify-end px-4 lg:px-6 sticky top-0 z-20">
      <div className="flex items-center gap-3 sm:gap-4 ml-4">
        ...
        {/* NOTIFICATION BELL (Now routes to the dedicated page) */}
        <button 
        ...
        {/* USER PROFILE BUBBLE (100% UNTOUCHED) */}
